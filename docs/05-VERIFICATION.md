...
| `INV-004` Runtime Proof Required | **L5** | **L5 (PASS: Gates 1–6)** | Gates 1–6 live runtime verified (catalog, Responses non-stream/stream, tool roundtrip, Codex->Astra, Codex->Gemini file edit loop); Gates 7–10 pending |
